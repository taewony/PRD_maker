  ...
  return (
    <main className="container mx-auto p-8">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold">PRD Maker</h1>
        <p className="text-lg text-gray-600 mt-2">
          AI와의 협업을 위한 제품 요구사항 문서(PRD)와 실행 계획을 자동으로 생성합니다.
        </p>
      </div>
        ...
        {questions.map((question, index) => (
          <div key={index}>
            ...
            <textarea
              ...
              placeholder={exampleAnswers[index]}
              rows={4}
              className="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 placeholder-gray-400"
            />
          </div>
        ))}
      </div>
